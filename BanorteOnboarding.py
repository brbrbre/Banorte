...
class App(Tk):
    def __init__(self):
        ...
        self.images = {
                "modulo_1": ImageTk.PhotoImage(Image.open("bienestar_f.png").resize((300, 150))),
                "modulo_2": ImageTk.PhotoImage(Image.open("tarjeta_cred.png").resize((300, 150))),
                "modulo_3": ImageTk.PhotoImage(Image.open("planeando_fut.png").resize((300, 150))),
                "modulo_4": ImageTk.PhotoImage(Image.open("ahorro.png").resize((300, 150)))
            }
    ...
    def verificar_datos(self):
        ...
        #si están en blanco no deja continuar
        ...
        #si las contraseñas coinciden se guarda el usuario en la "base de datos"
